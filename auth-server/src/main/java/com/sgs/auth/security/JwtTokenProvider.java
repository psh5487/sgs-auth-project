...
public class JwtTokenProvider {
    ...
    public String createAccessToken(User user) {
        return createToken(user.getEmail(), user.getRole().toString(), ACCESS_TOKEN_VALID_TIME);
    }

    // Refresh 토큰 생성하기
    public String createRefreshToken(User user) {
        return createToken(user.getEmail(), user.getRole().toString(), REFRESH_TOKEN_VALID_TIME);
    }
}
